...
public class BuildTriggerConfig implements Describable<BuildTriggerConfig> {
    ...
    /**
     * @deprecated Use {@link #getProjectList(ItemGroup, EnvVars)}
     */
    ...
    /**
     * @param env Environment variables from which to expand project names;
     * Might be {@code null}.
     * @param context The container with which to resolve relative project
     * names.
     */
    ...
    /**
     * @return Inner list represents a set of build parameters used together for
     * one invocation of a project, and outer list represents multiple
    ...
    public static class DescriptorImpl extends Descriptor<BuildTriggerConfig> {
        ...
        public List<Descriptor<AbstractBuildParameters>> getBuilderConfigDescriptors() {
            return Hudson.getInstance().<AbstractBuildParameters, Descriptor<AbstractBuildParameters>>getDescriptorList(AbstractBuildParameters.class);
        }

        public List<Descriptor<AbstractBuildParameterFactory>> getBuilderConfigFactoryDescriptors() {
            return Hudson.getInstance().<AbstractBuildParameterFactory, Descriptor<AbstractBuildParameterFactory>>getDescriptorList(AbstractBuildParameterFactory.class);
        }
